...
const css = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card-number { font-size: 0.72rem; letter-spacing: 0.2em; color: var(--text-tertiary); margin-bottom: 1.25rem; font-weight: 500; }

  .card-name { font-size: 1.3rem; font-weight: 800; letter-spacing: 0.04em; margin-bottom: 0.6rem; line-height: 1; }
  .wordmark { font-family: 'Jost', sans-serif; font-weight: 800; font-style: oblique; }

  .card-desc { font-size: 0.92rem; color: var(--text-secondary); line-height: 1.7; flex: 1; }

  .card-footer { margin-top: 1.25rem; display: flex; align-items: center; justify-content: space-between; }

  .card-status { font-size: 0.72rem; letter-spacing: 0.12em; text-transform: uppercase; font-weight: 600; }
      ...
      <div className="wrapper">
        <header>
          <div className="header-inner">
            ...
            <span className="header-tagline">adaptive intelligence chief-of-staff</span>
